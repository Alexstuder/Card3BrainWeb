...
export class CardRestControllerService {
     ...
     */
    public createCard(card: Array<Card>, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: '*/*', context?: HttpContext}): Observable<CardsDto>;
    public createCard(card: Array<Card>, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: '*/*', context?: HttpContext}): Observable<HttpResponse<CardsDto>>;
    public createCard(card: Array<Card>, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: '*/*', context?: HttpContext}): Observable<HttpEvent<CardsDto>>;
    public createCard(card: Array<Card>, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: '*/*', context?: HttpContext}): Observable<any> {
        if (card === null || card === undefined) {
            throw new Error('Required parameter card was null or undefined when calling createCard.');
        }
        ...
        return this.httpClient.post<CardsDto>(`${this.configuration.basePath}/api/cards/add`,
            card,
            {
